      ...
      items: [
        {
          ...
          onChange: (value: string) => setNotifications(value === 'true'),
          onPress: undefined,
          icon: 'notifications',
        },
        {
          type: 'switch',
          label: 'Email Updates',
          value: emailUpdates.toString(),
          onChange: (value: string) => setEmailUpdates(value === 'true'),
          onPress: undefined,
          icon: 'email',
        },
        {
          type: 'switch',
          label: 'SMS Updates',
          value: smsUpdates.toString(),
          onChange: (value: string) => setSmsUpdates(value === 'true'),
          onPress: undefined,
          icon: 'sms',
        },
      ],
              ...
              <View key={itemIndex} style={styles.settingItem}>
                ...
                {item.type === 'switch' && (
                  <Switch
                    ...
                    onValueChange={(value) => item.onChange?.(value.toString())}
                    trackColor={{ false: '#767577', true: '#81b0ff' }}
                    thumbColor={item.value === 'true' ? '#f5dd4b' : '#f4f3f4'}
                  />
                )}
